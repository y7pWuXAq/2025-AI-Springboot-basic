...
public class Day0201_MemberController {
    ...
    public String getMemberView(@RequestParam String mem_id) {
        ...
        if(mem == null) {
            return "아이디(%s)에 대한 조회 결과가 없습니다.".formatted(mem_id);
        }
    ...
    public String getMemberInsert() {
        return "Day0201_MemberController : 회원 정보입력 창 입니다.";
    }

    // 회원 정보수정
    @GetMapping(path="/update")
    public String getMemberUpdate() {
        return "Day0201_MemberController : 회원 정보수정 창 입니다.";
    }

    // 회원 정보삭제
    @GetMapping(path="/delete")
    public String getMemberDelete() {
        return "Day0201_MemberController : 회원 정보삭제 창 입니다.";
    }
}
